...
VALUES
  -- Sauna
  ((SELECT id FROM public.protocols WHERE name = 'Sauna'),
  ...
  -- Hot Bath
  ((SELECT id FROM public.protocols WHERE name = 'Hot Bath'),
  ...
  -- Cold Plunge
  ((SELECT id FROM public.protocols WHERE name = 'Cold Plunge'),
  ...
  -- Cold Shower
  ((SELECT id FROM public.protocols WHERE name = 'Cold Shower'),
   'Buijze GA, Sierevelt IN, van der Heijden BC, Dijkgraaf MG, Frings-Dresen MH',
   2016, 'The Effect of Cold Showering on Health and Work: A Randomized Controlled Trial',
   'PLOS ONE', '10.1371/journal.pone.0161749',
   'https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0161749'),
  ...
  -- HIIT
  ((SELECT id FROM public.protocols WHERE name = 'HIIT'),
  ...
  -- Zone 2 Cardio
  ((SELECT id FROM public.protocols WHERE name = 'Zone 2 Cardio'),
   'Seiler S',
  ...
  -- Resistance Training
  ((SELECT id FROM public.protocols WHERE name = 'Resistance Training'),
  ...
  -- Creatine
  ((SELECT id FROM public.protocols WHERE name = 'Creatine'),
  ...
  -- Omega-3
  ((SELECT id FROM public.protocols WHERE name = 'Omega-3'),
   'Calder PC',
  ...
  -- Vitamin D
  ((SELECT id FROM public.protocols WHERE name = 'Vitamin D'),
   'Holick MF',
  ...
  -- Sleep Hygiene
  ((SELECT id FROM public.protocols WHERE name = 'Sleep Hygiene'),
   'Walker M',
  ...
  -- Meditation
  ((SELECT id FROM public.protocols WHERE name = 'Meditation'),
  ...
  ((SELECT id FROM public.protocols WHERE name = 'Deprecated Protocol'),
   'Test Author',
