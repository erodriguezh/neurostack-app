...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DomainFailure&&(identical(other.code, code) || other.code == code)&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'DomainFailure(code: $code, message: $message)';
}
...
class _DomainFailure implements DomainFailure {
  const _DomainFailure({required this.code, required this.message});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DomainFailure&&(identical(other.code, code) || other.code == code)&&(identical(other.message, message) || other.message == message));
}
