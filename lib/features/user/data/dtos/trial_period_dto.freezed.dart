...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String startDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrialPeriodDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String startDate)  $default,) {final _that = this;
switch (_that) {
case _TrialPeriodDto():
return $default(_that.startDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String startDate)?  $default,) {final _that = this;
switch (_that) {
case _TrialPeriodDto() when $default != null:
return $default(_that.startDate);case _:
  return null;
...
class _TrialPeriodDto extends TrialPeriodDto {
  const _TrialPeriodDto({required this.startDate}): super._();
