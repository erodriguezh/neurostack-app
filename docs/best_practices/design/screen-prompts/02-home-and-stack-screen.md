...
- Protocol name: "Norwegian 4×4 HIIT" - Inter, 18px, font-weight: 500, text-white/90, mt-4, tracking-tight (-0.025em)

- Quick reference: "4×4 min at 90-95% HR, 3×/wk" - Inter, 13px, font-weight: 300, text-white/50, mt-2, leading-relaxed
